...
void Shader::loadShader() {
	...
	loadFile(("assets/shaders/vertex/" + name + "vert.glsl").c_str(), vertexSourceStream);
	loadFile(("assets/shaders/fragment/"+ name + "frag.glsl").c_str(), fragmentSourceStream);
